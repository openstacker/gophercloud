		...
		fmt.Fprintf(w, `
{
  ...
  "master_count": 1,
  "clustertemplate_id": "472807c2-f175-4946-9765-149701a5aba7",
  "master_addresses": [
    "172.29.248.97"
  ],
  "node_count": 1,
		...
		fmt.Fprintf(w, `
{
  "errors": [
	...
	th.AssertEquals(t, "Cluster mccluster could not be found.", err.Error())
...
func TestKubernetesCredentialsBundleScripts(t *testing.T) {
	th.SetupHTTP()
	defer th.TeardownHTTP()
		...
		fmt.Fprintf(w, `
{
  ...
  "stack_id": "7590db28-9d80-4e33-8aeb-57c09085828a",
  "created_at": "2016-08-16T14:11:31+00:00",
  "api_address": "https://172.29.248.123:6443",
  "discovery_url": "https://discovery.etcd.io/0d1e5076f84678db8865ab99debb5516",
  "updated_at": "2016-08-16T14:15:14+00:00",
  "master_count": 1,
  "clustertemplate_id": "472807c2-f175-4946-9765-149701a5aba7",
		...
		fmt.Fprintf(w, `
{
  ...
  "links": [
	...
	cmd := `set KUBECONFIG=%~dp0kubectl.config
set DOCKER_VERSION=1.9.1
`
	th.AssertEquals(t, cmd, string(b.Scripts["kubectl.cmd"]))

	ps1 := `$env:KUBECONFIG="$PSScriptRoot\kubectl.config"
$env:DOCKER_VERSION="1.9.1"
`
	th.AssertEquals(t, ps1, string(b.Scripts["kubectl.ps1"]))
...
export DOCKER_VERSION=1.9.1
`
	th.AssertEquals(t, env, string(b.Scripts["kubectl.env"]))
...
set -x DOCKER_VERSION 1.9.1
`
	th.AssertEquals(t, fish, string(b.Scripts["kubectl.fish"]))

	config := `apiVersion: v1
clusters:
- cluster:
    certificate-authority: ca.pem
    server: https://172.29.248.123:6443
  name: mccluster
contexts:
- context:
    cluster: mccluster
...
- name: mccluster
  user:
    ...
    client-key: key.pem
`
	th.AssertEquals(t, config, string(b.Scripts["kubectl.config"]))
}
